...
public class NodeInput : ScriptableObject
{
	...
	{
		rect = new Rect (body.rect.x, body.rect.y + labelRect.y, labelRect.width + labelRect.x, labelRect.height);
	}
	...
	public Rect GetKnob () 
	{
		...
		return new Rect (rect.x - knobSize, rect.y + (rect.height - knobSize) / 2,  knobSize, knobSize);
	}
